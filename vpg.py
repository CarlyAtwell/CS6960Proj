...
### TODO: need to change form cartpole to our application
...
######## By default designed to work with Cartpole --> TODO: will need to change for image filtering
# def train( hidden_sizes=[32], lr=1e-2, epochs=50, batch_size=5000, render=False, reward=None, checkpoint = False, checkpoint_dir = "\."):

   
#   # TODO: figure out what these would be / not sure if need these
#    obs_dim = None
#    n_acts = None
#
#    # make core of policy network
#    # TODO: Adjust sizes for neural network based on sizes we need for images+filters
...
#        obs = ???               # TODO: first obs comes from ???
#        done = False            # TODO: signal from environment that episode is over
#        ep_rews = []            # list for rewards accrued throughout ep
#
#        # render first episode of each epoch
#        finished_rendering_this_epoch = False ## TODO: idk what this means
#
#        # collect experience by acting in the environment with current policy
#        # TODO: all this stuff hella different for images
#        while True:
#
#            # rendering
